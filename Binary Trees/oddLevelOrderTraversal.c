...
void oddlevelOrderTraversal(BSTNode *node);
...
int main()
{
	...
	while (c != 0)
	{
		...
		case 1:
			...
			break;
		case 2:
			printf("The resulting odd level-order traversal of the binary search tree is: ");
			oddlevelOrderTraversal(root); // You need to code this function
			printf("\n");
			break;
		case 0:
			removeAll(&root);
...
void oddlevelOrderTraversal(BSTNode* root)
{
    Queue q;
    int preLvlCount =1, isOdd = 1, curLvlCount=1;
    q.head = NULL;
    q.tail = NULL;
